...
module Akismet
  ...
  def self.included(controller)
    controller.helper_method(:is_spam?, :submit_spam, :submit_ham) if controller.respond_to? :helper_method
  end
  ...
  def initialize
    ...
    @proxyPort = nil
    @proxyHost = nil
    @akismetBlog = ""   # Home URL of the instance making the request
    @akismetKey = SiteConfig['akismet_key']    # Your API key from WordPress
    # instance_eval do
